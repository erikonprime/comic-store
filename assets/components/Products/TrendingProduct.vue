        ...
        <div class="col-lg-12">
          <div class="li-product-tab li-trending-product-tab">
            ...
            <ul class="nav li-product-menu li-trending-product-menu">
              <li><a class="active" data-toggle="tab" href="#home1"><span>category 1</span></a></li>
              <li><a data-toggle="tab" href="#home2"><span>category 2</span></a></li>
              <li><a data-toggle="tab" href="#home3"><span>category 3</span></a></li>
            </ul>
          </div>
